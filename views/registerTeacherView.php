...
<div class="container d-flex justify-content-center align-items-center h-100">
  <section class="login d-flex flex-column justify-content-center align-items-center rounded-3 bg-white w-50 P-5">
    ...
    <h1 class="">Profesor</h1>
    
    <form class="w-75" action="../controllers/registerTeacherController.php" method="post">
      ...
      <div class="row mb-3">
        ...
        <div class="col-12">
          <input type="text" class="form-control" placeholder="444-6674" aria-label="Telephone" name="telephone" id="telephone" required>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-12">
          <input type="text" class="form-control" placeholder="12345678A" aria-label="Nif" name="nif" id="nif" required>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-12">
          <input type="email" class="form-control" placeholder="teacher@mail.com" name="email" required>
        </div>
      </div>
      
      <input type="submit" class="d-inline-flex justify-content-center btn btn-primary" name="createTeacherButton" id="createTeacherButton" value="Guardar">
